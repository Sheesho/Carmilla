...
exports.run  = async (client, message, args, tools) =>
{
  ...
  if((args[0].toLowerCase() == "tickets") || (args[0].toLowerCase() == "ticket") || (args[0].toLowerCase() == "tixes") || (args[0].toLowerCase() == "tix"))
  {
    ...
    tcrystal = 0;
    ttenticket = 0;
    console.log("old tickets amount:" + tickets);
    console.log("added tickets amount:" + tticket);
    console.log("new tickets amount:" + (tticket + tickets));
  }
  else if((args[0].toLowerCase() == "crystal") || (args[0].toLowerCase() == "crystals") || (args[0].toLowerCase() == "xtal") || (args[0].toLowerCase() == "xtals"))
    {
      ...
      tticket = 0;
      ttenticket = 0;
      console.log("old crystal amount:" + crystals);
      console.log("added crystal amount:" + tcrystal);
      console.log("new crystal amount:" + (tcrystal + crystals));
    }
  else if((args[0].toLowerCase() == "10tixes") || (args[0].toLowerCase() == "10p") || (args[0].toLowerCase() == "10pticket") || (args[0].toLowerCase() == "10ptixes"))
    {
      ...
      tticket = 0;
      tcrystal = 0;
      console.log("old 10P amount:" + tentickets);
      console.log("added 10P amount:" + ttenticket);
      console.log("new 10P amount:" + (ttenticket + tentickets));
    }
  else
  {
  ...
  db.set(`userCrystals_${user.id}`, crystals + tcrystal);
  db.set(`userTickets_${user.id}`, tickets + tticket);
  db.set(`userTenTickets_${user.id}`, tentickets + ttenticket);
